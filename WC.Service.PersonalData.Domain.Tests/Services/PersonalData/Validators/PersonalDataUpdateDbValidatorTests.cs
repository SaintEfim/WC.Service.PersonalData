...
using WC.Service.PersonalData.Domain.Services.PersonalData.Validators.Update;

namespace WC.Service.PersonalData.Domain.Tests.Services.PersonalData.Validators;

public class PersonalDataUpdateDbValidatorTests
{
    private static PersonalDataUpdateDbValidator GetValidator(
        IMock<IPersonalDataRepository> repository)
    {
        ...
        builder.RegisterType<PersonalDataUpdateDbValidator>();

        builder.Populate([]);

        var container = builder.Build();
        return container.Resolve<PersonalDataUpdateDbValidator>();
    }

    [Fact]
    public async Task PersonalData_Positive_Update_New_Record()
    {
    ...
    [Fact]
    public async Task PersonalData_Negative_Update_New_Record_Has_Duplicate()
    {
        var personalData = PersonalData.PersonalDataModel();
